...
export const WEDDING_DATE = dayjs.tz("2026-01-31 12:30", "Asia/Seoul")
...
export const LOCATION = "충청북도 청주시 청원구 내수읍 충청대로 400"
export const LOCATION_ADDRESS = "메리다 웨딩홀 2층 달라이스"
...
export const BRIDE_FULLNAME = "조이성"
export const BRIDE_FIRSTNAME = "이성"
export const BRIDE_TITLE = "사녀"
export const BRIDE_FATHER = "조장훈"
export const BRIDE_MOTHER = "유카리"
...
export const GROOM_FULLNAME = "신창원"
export const GROOM_FIRSTNAME = "창원"
export const GROOM_TITLE = "장남"
export const GROOM_FATHER = "신강순"
export const GROOM_MOTHER = "사찌요"
